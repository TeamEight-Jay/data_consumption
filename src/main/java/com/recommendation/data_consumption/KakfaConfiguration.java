...
public class KakfaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, UpdateCategoryMessage> categoryUpdateProducerFactory() {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, UpdateCategoryMessage> categoryUpdateKafkaTemplate() {
